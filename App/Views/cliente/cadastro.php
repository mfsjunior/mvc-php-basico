...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            cliente/salvar" method="post" id="form_cadastro">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form=control"name="datanascimento" placeholder="Sua data de nascimento" value="<$php echo $Sessao::retornaValorFormulario('datanascimento'); ?>" required>
            </div>

            <div class="form-group">
                <label for="cpf">Cpf</label>
                <input type="text" class="form=control"name="cpf" placeholder="Seu Cpf" value="<$php echo $Sessao::retornaValorFormulario('cpf'); ?>" required>
            </div>
